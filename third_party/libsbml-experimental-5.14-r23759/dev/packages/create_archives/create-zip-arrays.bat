...
set VERSION=%PACKAGE_NAME%-5.14.0-beta-1
...
mkdir src\sbml\packages\%PACKAGE_NAME%\math
mkdir src\sbml\packages\%PACKAGE_NAME%\math\test
...
copy /y %PACKAGE_DIR%\src\sbml\packages\%PACKAGE_NAME%\math\*.h        src\sbml\packages\%PACKAGE_NAME%\math\
copy /y %PACKAGE_DIR%\src\sbml\packages\%PACKAGE_NAME%\math\*.cpp      src\sbml\packages\%PACKAGE_NAME%\math\
...
copy /y %PACKAGE_DIR%\src\sbml\packages\%PACKAGE_NAME%\math\test\*.h        src\sbml\packages\%PACKAGE_NAME%\math\test\
copy /y %PACKAGE_DIR%\src\sbml\packages\%PACKAGE_NAME%\math\test\*.cpp      src\sbml\packages\%PACKAGE_NAME%\math\test\
copy /y %PACKAGE_DIR%\src\sbml\packages\%PACKAGE_NAME%\math\test\*.c      src\sbml\packages\%PACKAGE_NAME%\math\test\
copy /y %PACKAGE_DIR%\src\sbml\packages\%PACKAGE_NAME%\math\test\*.txt      src\sbml\packages\%PACKAGE_NAME%\math\test\
