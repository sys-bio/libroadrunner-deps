...
public class SBMLInferUnitsConverter extends SBMLConverter {
   ...
   protected SBMLInferUnitsConverter(long cPtr, boolean cMemoryOwn)
   {
     super(libsbmlJNI.SBMLInferUnitsConverter_SWIGUpcast(cPtr), cMemoryOwn);
     swigCPtr = cPtr;
   }

   protected static long getCPtr(SBMLInferUnitsConverter obj)
   {
     return (obj == null) ? 0 : obj.swigCPtr;
   }

   protected static long getCPtrAndDisown (SBMLInferUnitsConverter obj)
   {
     long ptr = 0;
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        libsbmlJNI.delete_SBMLInferUnitsConverter(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
...
/**
 ...
 SBMLConverter cloneObject() {
    long cPtr = libsbmlJNI.SBMLInferUnitsConverter_cloneObject(swigCPtr, this);
...
/**
 ...
 ConversionProperties getDefaultProperties() {
    return new ConversionProperties(libsbmlJNI.SBMLInferUnitsConverter_getDefaultProperties(swigCPtr, this), true);
  }
