 ...
 *
 * @file    MultiIdentifierConsistencyConstraintsDeclared.cxx
...
addConstraint(new UniqueMultiComponentIds(MultiDupClaId, *this));

addConstraint(new UniqueSpeciesTypeInstanceIdsWithinMultiSpeciesType(MultiUnqId_SptIns, *this));

addConstraint(new UniqueSpeciesTypeComponentIndexIdsWithinMultiSpeciesType(MultiUnqId_SptCpoInd, *this));

addConstraint(new UniqueInSpeciesTypeBondIdsWithinMultiSpeciesType(MultiUnqId_InSptBnd, *this));
