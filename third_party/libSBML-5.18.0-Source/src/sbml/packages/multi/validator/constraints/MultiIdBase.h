...
#ifndef MultiIdBase_h
#define MultiIdBase_h
...
/**
 * The MultiIdBase Constraint is the base class for all SBML id constraints.  It
 ...
 * call getTypename().
 */
class MultiIdBase: public TConstraint<Model>
{
public:
   ...
   */
  MultiIdBase (unsigned int id, MultiValidator& v);
...
protected:
  ...
  void checkId (const MultiSpeciesType& x);
  ...
  void checkId (const SpeciesTypeInstance&  x);
