/**
 * @file RenderExtensionTypes.h
 * @brief Definition of RenderExtensionTypes.
 * @author SBMLTeam
 *
 * <!--------------------------------------------------------------------------
...
#ifndef RenderExtensionTypes_H__
#define RenderExtensionTypes_H__
...
#endif /* !RenderExtensionTypes_H__ */
