...
//
%typemap("csout") DistribDistribution*
{
  return (DistribDistribution) libsbml.DowncastSBase($imcall, $owner);
}
...
// possible.
//
%typemap("csout") DistribUnivariateDistribution*
{
  return (DistribUnivariateDistribution) libsbml.DowncastSBase($imcall,
    $owner);
}
...
//
%typemap("csout") DistribUncertValue*
{
  return (DistribUncertValue) libsbml.DowncastSBase($imcall, $owner);
}
