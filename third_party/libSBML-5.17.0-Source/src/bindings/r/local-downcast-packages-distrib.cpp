...
else if (pkgName == "distrib")
{
  switch ( sb->getTypeCode() )
  {
    case SBML_LIST_OF:
      ...
      {
        return SWIGTYPE_p_ListOfExternalParameters;
      }
      else if (name == "listOfCategories")
      {
        return SWIGTYPE_p_ListOfCategories;
      }
    ...
    case SBML_DISTRIB_DISTRIBUTION:
      return SWIGTYPE_p_DistribDistribution;

    case SBML_DISTRIB_UNIVARIATEDISTRIBUTION:
      return SWIGTYPE_p_DistribUnivariateDistribution;

    case SBML_DISTRIB_MULTIVARIATEDISTRIBUTION:
      return SWIGTYPE_p_DistribMultivariateDistribution;

    case SBML_DISTRIB_CONTINUOUSUNIVARIATEDISTRIBUTION:
      return SWIGTYPE_p_DistribContinuousUnivariateDistribution;

    case SBML_DISTRIB_DISCRETEUNIVARIATEDISTRIBUTION:
      return SWIGTYPE_p_DistribDiscreteUnivariateDistribution;

    case SBML_DISTRIB_CATEGORICALUNIVARIATEDISTRIBUTION:
      return SWIGTYPE_p_DistribCategoricalUnivariateDistribution;
